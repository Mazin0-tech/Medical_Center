                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.1s">Ut enim ad mmm minim veniam, quis nostrud
                                    exercitation ullamco laboris nisi uquip ex ea commodo consequat is aute irure.</p>
                                <a href="{{ route('patient_doctor')}}" class="btn hero-btn" data-animation="fadeInLeft"
                                    data-delay="0.5s">Doctors<i class="ti-arrow-right mx-4"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center no-gutters">
                            ...
                            <div class="col-lg-5">
                                <div class="dept_thumb">
                                    <img src="{{asset('img/gallery/department_man.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- single_content  -->
